...
function renderPost(post, myId) {
  ...
  <article class="post-card" data-id="${post.id}">
    ...
    <div class="post-body">
      ...
      ${post.media_url && post.media_type === 'video' ? `<video class="post-image" src="${escapeHtml(post.media_url)}" controls preload="metadata" style="max-height:320px;width:100%;border-radius:12px;border:1px solid var(--border)"></video>` : post.media_url ? `<img class="post-image" src="${escapeHtml(post.media_url)}" alt="Post image" loading="lazy"/>` : ""}
